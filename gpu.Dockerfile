...
# build: docker build -f gpu.Dockerfile -t kengz/github-actions-gpu:0.0.3 -t kengz/github-actions-gpu:latest .
# push: docker push kengz/github-actions-gpu:0.0.3; docker push kengz/github-actions-gpu:latest
